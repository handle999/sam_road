...
# from models.sam_road_contra import SAMRoad
# from models.sam_road_contra_gt import SAMRoad
...
if __name__ == "__main__":
    ...
    if config.DATASET == 'cityscale':
        ...
        gt_graph_pattern = 'datasets/cityscale/20cities/region_{}_graph_gt.pickle'
    ...
    for img_id in test_img_indices:
        ...
        if config.DATASET in ('spacenet', 'xian', 'didi_xian'):
            # convert ??? -> xy -> rc
